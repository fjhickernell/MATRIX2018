  ...
  methods
    ...
    function [prob,out] = compProb(obj)
      ...
      elseif strcmp(obj.errMeth,'g')
        ...
        elseif strcmp(obj.cubMeth,'Lattice')
          [prob, out] = cubLattice_g(obj.f, ...
            [zeros(1,realDim); ones(1,realDim)], ...
            'uniform',obj.absTol,obj.relTol);
        elseif strcmp(obj.cubMeth,'BayesLattice') %Fred's version
           [prob, out] = cubBayesLattice(obj.f,realDim,obj.absTol, ...
              obj.relTol,obj.bernPolyOrder,obj.arbMean);
        elseif strcmp(obj.cubMeth,'MLELattice')
          ...
          objCubMLE=cubMLELattice('f',obj.f, 'dim',realDim, ...
            'absTol',obj.absTol, 'relTol',obj.relTol,...
            'order',obj.bernPolyOrder, 'ptransform',obj.ptransform, ...
            'stopAtTol',obj.stopAtTol, 'figSavePath',obj.figSavePath, ...
            'fName',obj.fName, 'arbMean',obj.arbMean);
          [prob,out]=compInteg(objCubMLE);
        elseif strcmp(obj.cubMeth,'MLESobol')
          objCubMLE=cubMLESobol('f',obj.f, 'dim',realDim, ...
            'absTol',obj.absTol, 'relTol',obj.relTol,...
            'order',obj.bernPolyOrder, 'ptransform',obj.ptransform, ...
            'stopAtTol',obj.stopAtTol, 'figSavePath',obj.figSavePath, ...
            'fName',obj.fName, 'arbMean',obj.arbMean);
